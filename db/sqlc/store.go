...
// SQLStore provides all functions to execute SQL and transactions
...
// creates a transfer record, account entries, account balance update within a single transaction
